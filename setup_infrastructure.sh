...
terraform init -var AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID}
terraform plan -var AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID} -var AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY} -var "management_ip=$MANAGEMENT_IP"
terraform apply -var AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID} -var AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY} -var "management_ip=$MANAGEMENT_IP" -auto-approve
